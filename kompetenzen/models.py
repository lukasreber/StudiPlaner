...
class course(models.Model):
    ...
    type            = models.ForeignKey(course_type, null=True, on_delete=models.SET_NULL, blank=True)
    group           = models.ForeignKey(course_group, null=True,on_delete=models.SET_NULL, blank=True)
